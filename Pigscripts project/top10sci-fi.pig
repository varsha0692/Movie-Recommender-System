...
sci-Fi = FILTER C by $3 == 'Sci-Fi' or $4== 'Sci-Fi' or  $5 == 'Sci-Fi' or $6=='Sci-Fi' or $7=='Sci-Fi' or $8=='Sci-Fi';

joind = JOIN sci-Fi by movie_id,ratings by movie_id;
