...
children = FILTER C by $3 == 'Children' or $4== 'Children' or  $5 == 'Children' or $6=='Children' or $7=='Children' or $8=='Children';

joind = JOIN children by movie_id,ratings by movie_id;
...
STORE top10 INTO './top10Children';