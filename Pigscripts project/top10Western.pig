...
western = FILTER C by $3 == 'Western' or $4== 'Western' or  $5 == 'Western' or $6=='Western' or $7=='Western' or $8=='Western';

joind = JOIN western by movie_id,ratings by movie_id;
