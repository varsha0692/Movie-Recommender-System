...
crime = FILTER C by $3 == 'Crime' or $4== 'Crime' or  $5 == 'Crime' or $6=='Crime' or $7=='Crime' or $8=='Crime';

joind = JOIN crime by movie_id,ratings by movie_id;
