...
adventure = FILTER C by $3 == 'Adventure' or $4== 'Adventure' or  $5 == 'Adventure' or $6=='Adventure' or $7=='Adventure' or $8=='Adventure';
...
joind = JOIN adventure by movie_id,ratings by movie_id;

fr = FOREACH joind generate movie_name,movie_rating,year;

gr = GROUP fr by movie_name;
V = FOREACH gr generate group as movie_name,AVG(fr.movie_rating),adventure.year;
ord = ORDER V by $1 desc;
top10 = limit ord 10;

STORE top10 INTO './top10adventure';