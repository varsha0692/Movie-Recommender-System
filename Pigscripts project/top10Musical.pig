...
musical = FILTER C by $3 == 'Musical' or $4== 'Musical' or  $5 == 'Musical' or $6=='Musical' or $7=='Musical' or $8=='Musical';

joind = JOIN musical by movie_id,ratings by movie_id;
