...
romance = FILTER C by $3 == 'Romance' or $4== 'Romance' or  $5 == 'Romance' or $6=='Romance' or $7=='Romance' or $8=='Romance';

joind = JOIN romance by movie_id,ratings by movie_id;
