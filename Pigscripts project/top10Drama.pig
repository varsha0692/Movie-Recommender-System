...
drama = FILTER C by $3 == 'Drama' or $4== 'Drama' or  $5 == 'Drama' or $6=='Drama' or $7=='Drama' or $8=='Drama';

joind = JOIN drama by movie_id,ratings by movie_id;
