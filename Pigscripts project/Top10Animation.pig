...
animation = FILTER C by $3 == 'Animation' or $4== 'Animation' or  $5 == 'Animation' or $6=='Animation' or $7=='Animation' or $8=='Animation';

joind = JOIN animation by movie_id,ratings by movie_id;
...
STORE top10 INTO './top10Animation';