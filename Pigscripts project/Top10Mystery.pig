...
mystery = FILTER C by $3 == 'Mystery' or $4== 'Mystery' or  $5 == 'Mystery' or $6=='Mystery' or $7=='Mystery' or $8=='Mystery';

joind = JOIN mystery by movie_id,ratings by movie_id;
